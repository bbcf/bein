...
sys.path.insert(0, os.path.abspath('../')); import bein
...
version = bein.__version__
# The full version, including alpha/beta/rc tags.
release = bein.__version__
...
latex_documents = [
  ('index', 'bein.tex', u'bein Documentation', u'EPFL BBCF', 'manual'),
]
...
man_pages = [
    ('index', 'bein', u'bein Documentation', [u'EPFL BBCF'], 1)
]
